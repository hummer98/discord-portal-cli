...
# インストール元
SRC_SKILL="${SCRIPT_DIR}/skills/create-bot/SKILL.md"
SRC_COMMAND="${SCRIPT_DIR}/commands/create-bot.md"

# インストール先
DEST_SKILL="${HOME}/.claude/skills/create-bot/SKILL.md"
DEST_COMMAND="${HOME}/.claude/commands/create-bot.md"
...
do_uninstall() {
  ...
  # 空ディレクトリの削除
  local skill_dir="${HOME}/.claude/skills/create-bot"
